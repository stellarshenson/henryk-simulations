...
- The apartment door **opens outward to the west** - when open, the door panel swings into the corridor and rests on the west side of the door envelope, partially occupying segment 2's western corridor space.
- The N-S distance between the two doors is **approximately 2 m**.
- Segment 1 (entrance) is narrower than segment 2 and runs along the south side; segment 2 widens northward so the apartment door has room to open outward.

## Position of each party at the moment of the contested incident

- **Andrew**: stands in segment 2 with his **back pressed flat against the elevator door** (back fully against the S wall). His body faces **N**, toward the apartment door. He arrived at this position after Victoria asked him to step aside; pressing himself flat against the door is his maximum-retreat position - he cannot move further south.
...
With each actor's facing direction fixed by the orientations above, body-relative directions resolve as follows:
...
- front = N
- back = S (pressed against elevator door)
- left = W
- right = E (toward [Box])

**Cecilia** (faces E):

- front = E (into segment 2)
- back = W
- left = N
- right = S
...
- N-S distance between apartment door (N wall) and elevator door (S wall) of segment 2: **approximately 2 m**
- Apartment door width: **approximately 1 m** (standard Polish residential interior-door width)
- Apartment door opens to the W, panel (~1 m wide) projects into segment 2 west of the door envelope
- Briefcase [Box] footprint: approximately **50 cm × 30 cm**
- The apartment door is slightly **further east** than the elevator door
- From Victoria's standing position (at the W side of the apartment door, facing S): the **elevator door is in the diagonal front-right direction** (SW of her - directly south is the corridor space; the elevator door itself is south-west of her, since the apartment door is east of the elevator door). With V's right = W, this places the elevator door at her front-right.

This document records the layout and positions only. Kinematic and forensic analysis of the contested motion is in `events_reconstruction.md`; testimony content is in `testimony_victim.md` and `testimony_3rd_party.md`.
